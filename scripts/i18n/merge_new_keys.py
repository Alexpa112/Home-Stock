...
NUEVAS = {
    ...
    "continuar_apple": {"es": "Continuar con Apple", "gl": "Continuar con Apple", "en": "Continue with Apple", "pt": "Continuar com a Apple", "fr": "Continuer avec Apple", "it": "Continua con Apple", "de": "Mit Apple fortfahren"},
    ...
    "err_oauth_apple_generico": {"es": "Error de Apple: {error}", "gl": "Erro de Apple: {error}", "en": "Apple error: {error}", "pt": "Erro da Apple: {error}", "fr": "Erreur Apple : {error}", "it": "Errore di Apple: {error}", "de": "Apple-Fehler: {error}"},
    "err_oauth_apple_identidad": {"es": "No se pudo verificar la identidad de Apple.", "gl": "Non se puido verificar a identidade de Apple.", "en": "Couldn't verify Apple identity.", "pt": "Não foi possível verificar a identidade da Apple.", "fr": "Impossible de vérifier l'identité Apple.", "it": "Impossibile verificare l'identità Apple.", "de": "Apple-Identität konnte nicht überprüft werden."},
    "err_oauth_apple_fallo": {"es": "No se pudo completar el inicio de sesión con Apple. Inténtalo de nuevo.", "gl": "Non se puido completar o inicio de sesión con Apple. Téntao de novo.", "en": "Couldn't complete sign-in with Apple. Please try again.", "pt": "Não foi possível concluir o login com a Apple. Tente novamente.", "fr": "Impossible de terminer la connexion avec Apple. Réessayez.", "it": "Impossibile completare l'accesso con Apple. Riprova.", "de": "Die Anmeldung mit Apple konnte nicht abgeschlossen werden. Bitte versuche es erneut."},
